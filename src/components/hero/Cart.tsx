...
export const Cart = () => {
  return (
    <div className="flex flex-col w-[533px] px-[15px] py-[24px] border border-black-50 rounded-md max-h-max">
      ...
      <div className="grid mt-6 gap-[15px] ">
        {cartData &&
          cartData.map((item: Product) => (
            <div key={item.id} className="flex  gap-4  ">
              {/* Product Image */}
              <div className=" bg-white-400 relative w-[126px] h-[126px]  rounded-md flex items-center justify-center p-[7px]">
      ...
      {/* <div className="grid h-[124px] border2 mt-[26px] gap-[13.56px] ">
        {cartData &&
          cartData.map((item: Product) => {
            return (
              <div key={item.id} className="flex   gap-[15px]">
                <div className="w-[124px]  h-[124px]  bg-black-50 rounded-md">
                  <div className="h-[110px] w-[110px] relative">
                    <Image src={item.image} alt="product" fill />
                  </div>
                </div>
                <div className="flex  h-[124px] border-2 border-black p-0 flex-col gap-3">
                  <p className="text-lg font-normal text-black">{item.name}</p>
                  <p className="text-base font-normal text-white-900">
                    {item.description}
                  </p>
